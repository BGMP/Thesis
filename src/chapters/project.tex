...
\begin{center}
	\begin{tabular}{|lll|l|l|ll|}
		...
		Grande &
		X &
		\multicolumn{2}{l|}{\multirow{2}{*}{\begin{tabular}[c]{@{}l@{}}El software a construir require mcuhas\\funcionalidades.\end{tabular}}} \\ \cline{4-5}
		\multicolumn{3}{|l|}{} &
		Pequeño &
		&
		\multicolumn{2}{l|}{} \\ \hline
		...
		Existe &
		&
		\multicolumn{2}{l|}{\multirow{2}{*}{\begin{tabular}[c]{@{}l@{}}El sistema de RVA está fuertemente\\acoplado. Existe mínima modularización.\end{tabular}}} \\ \cline{4-5}
		\multicolumn{3}{|l|}{} &
		No existe&
		X &
		\multicolumn{2}{l|}{} \\ \hline

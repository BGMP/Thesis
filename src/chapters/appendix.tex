...
Se tiene entonces que el total es 28, con lo que sustituyendo en la fórmula del EF, quedaría:
...
También se ha determinado que todos los actores son de tipo complejo, ya que todos actúan mediante interfaces gráficas. Con esta lógica, se tiene que:

\[
 4 \text{ actores} \cdot 3 = 12 \text{ UAW} \text{ (peso de complejidad por actor)}
\]

A partir de estos cálculos, es posible obtener los puntos de casos de uso no ajustados (UCCP):
...
Luego, utilizando el TCF y EF calculados con anterioridad, es posible calcular los puntos de caso de uso ajustados por la complejidad técnica y complejidad ambiental.
...
\[
UCP = 431 \cdot 0.94 \cdot 0.56 \approx 226
\]


Finalmente, a partir del esfuerzo del proyecto, se ha calculado un nivel de esfuerzo:
\[
LOE = \frac{384}{226} \approx 1.7 \text{ horas por punto de caso de uso}
\]

...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=16cm, height=10cm]{raw-results.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=19cm, height=10cm]{bpmn1.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=17cm, height=16cm]{io-results.png}
  \end{center}
